...
public class CalendarEx1 {
    private static void showDateTime(Calendar calendar) {
        ...
        System.out.printf("%s: milliseconds = %d, %d-%d-%d %d:%d:%d%n",
    ...
    public static void main(String[] args) {
        ...
        showDateTime(calendar1);
        showDateTime(calendar2);
        showDateTime(calendar3);
        showDateTime(calendar4);
    }
}
